...
export default function CropperImage() {
    ...
    useEffect(() => {
          ...
          try {
            ...
            // Clear the canvas when selectedImage changes
            ctx.clearRect(0, 0, canvas.width, canvas.height);
  ...
  return (
    ...
    //       <h4>Please Choose Image</h4>
    //       <input type="file" onChange={handleImageChange} />
    //       <p className='mt-2'>please draw cropped area on the below image and then crop</p>
    //       {selectedImage && (
    //     <div style={{position:"relative" , marginTop:"10px"}}>
    //         <img src={selectedImage} alt="" style={{ width:500 , height:400 ,  position:"absolute",  top:"0" , left:"0"}}  />
    //       <canvas
    ...
    //        {croppedImage && <img src={croppedImage} alt="Cropped" style={{ width: "auto" , height:"400px"}} />}
    //       <button onClick={handleCrop} className='btn btn-primary'>Crop</button>
    //        { croppedImage && <button className='btn btn-primary' onClick={handleDownload}>Download</button>}
    //         </div>
        ...
        <div className="col-lg-6 col-sm-12">
            <div style={{position:"relative" , height:"500px" , display:"flex" , justifyContent:"center"}}>
                ...
                <div style={{position:"relative"}}>
                    {selectedImage && 
                    <>
                     <img src={selectedImage} alt="" style={{ width:450  , height: 400  ,  position:"absolute",  top:"0" , left:"0"}}  />
                     <canvas
                            style={{position:"absolute" , top:"0" , left:"0"  }}
                             ref={canvasRef}
